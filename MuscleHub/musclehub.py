...
colors = ['skyblue', 'gold']
plt.pie(ab_counts.first_name, labels=['A', 'B'],colors=colors,autopct='%0.2f%%',)
plt.axis('equal')
plt.title('Visits by Group A and Group B')
plt.show()
...
#app_pivot['Percent with Application']=app_pivot['Percent with Application'].apply('{:.2%}'.format)
app_pivot
...
#member_pivot['Percent Purchase']=member_pivot['Percent Purchase'].apply('{:.2%}'.format)
...
#final_member_pivot['Percent Purchase']=final_member_pivot['Percent Purchase'].apply('{:.2%}'.format)
final_member_pivot
...
ax.set_title('Percent of visitors fill out the application')
...
ax.set_title('Percent of purchrase membership who fill out the application')
...
ax.set_title('Percent purchase overall')
plt.show()
